...
class DataSet(object): 
    ...
    def randomBatch(self, batchSize):
        ...
        rewards=numpy.zeros((batchSize,1),dtype=tf.float32)
...
def trivial_tests():
    ...
    state1 = numpy.array([1], dtype=tf.float32)
    state2 = numpy.array([2], dtype=tf.float32)
    state3 = numpy.array([3], dtype=tf.float32)
